...
console.log('moduleType', typeof pdfParseModule);
console.log('keys', Object.keys(pdfParseModule));
console.log('defaultType', pdfParseModule.default ? typeof pdfParseModule.default : 'none');
console.log('parseType', pdfParseModule.parse ? typeof pdfParseModule.parse : 'none');
...
try {
  ...
  console.error('pdfParse call error', e);
}
